...
public class TurnosbyPacienteTableGenerator {

    private static TurnosbyPacienteTableGenerator turnosbyPacienteTableGenerator;

    public static TurnosbyPacienteTableGenerator getInstance(){
        if(turnosbyPacienteTableGenerator ==null){
            turnosbyPacienteTableGenerator= new TurnosbyPacienteTableGenerator();
        }
        return turnosbyPacienteTableGenerator;
    }

    private  TurnosbyPacienteTableGenerator(){

    }

    public JTable generateTable(List<Turno> turnos, Paciente paciente) {
        ...
        if(turnos != null){
            for (Turno turno:turnos) {
                ...
                vector.add(1,Long.toString(paciente.getDni()));
